...
const reddit = simpleOAuth2Reddit.create({
	clientId: CONFIG.REDDIT_API_CLIENT, //process.env.REDDIT_API_CLIENT
	clientSecret: CONFIG.REDDIT_API_SECRET, //process.env.REDDIT_API_SECRET, //z1BZIEIUJfDV80_PfJ8Xd8LpH_8
	callbackURL: CONFIG.REDDIT_API_REDIRECT,
